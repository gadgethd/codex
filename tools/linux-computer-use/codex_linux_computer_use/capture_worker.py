"""One-shot GStreamer worker; the parent bounds native startup and shutdown."""
...
if __name__ == "__main__":
    try:
        frame = capture_png(*(int(value) for value in sys.argv[1:]))
        sys.stdout.buffer.write(frame["png"])
